...
def launch_setup(context, *args, **kwargs):
    ...
    # Coverage path planning server (Fields2Cover) - generates mowing patterns via /area_coverage service
    coverage_server = Node(
        ...
        parameters=[
            {
                "use_sim_time": use_sim_time,
                # NOTE: placeholder values below - override with real chassis/blade dimensions once known
                "robot_width": 0.325,
                "operation_width": 0.3,
    ...
    mission_manager = Node(
        ...
        parameters=[
            {
                "use_sim_time": use_sim_time,
                "target_area_id": "0859c0c1-ec2d-4197-96b7-2d12f6cf1cd9",
                "battery_low_percent": 30.0,
                "battery_charged_percent": 95.0,
                "autostart": True,
            }
        ],
    )
    ...
    return [
        ...
        localization,
        nav2,
        TimerAction(period=5.0, actions=[coverage_server]),
